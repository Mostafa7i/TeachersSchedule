...
const adminNavItems = [
  ...
  },
  {
    ...
    label: "صندوق الشكاوى والمقترحات",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
...
const teacherNavItems = [
  ...
  {
    href: "/dashboard/teacher/lesson-preparation",
    label: "دفتر تحضير الدروس والخطط",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  {
    href: "/dashboard/teacher/available-timetables",
    label: "الجداول المتاحة للاختيار",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  
  {
    ...
    label: "إعدادات المعلم والملف الشخصي",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
